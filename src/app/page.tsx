...
import { GitHubIcon, LinkedInIcon, MailIcon, BriefcaseIcon, ArrowDownIcon } from '@/components/Icons'
		...
		<>
			<Container className="mt-9">
				<div className="max-w-2xl">
					<h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">Software developer, musician, and something else</h1>
