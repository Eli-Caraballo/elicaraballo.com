...
export function ToolsIcon(props: React.ComponentPropsWithoutRef<'svg'>) {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" fill="#f4f4f5" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#a1a1aa" {...props}>
			<path
				strokeLinecap="round"
